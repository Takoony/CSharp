...
namespace SR_EventListServer
{
    public partial class Form4 : Form
    {
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql_cmd = @"use [import_event]   select [SE_INDEX], [SE_title],[SE_volatility],[SE_reason],[SE_effect_date] from [ShortEvent]";
                ...
                this.dataGridView1.DataSource = ds.Tables["ShortEvent"];
        ...
        {
            DataTable dt = ds.Tables["ShortEvent"];
            ...
            sda.Update(ds.Tables["ShortEvent"]);
        }
        ...
        private void update_Click(object sender, EventArgs e)
        {
            if (ds.HasChanges())
            {
                try
                {
                    ...
                    sda.InsertCommand = SCB.GetInsertCommand();
                    sda.Update(ds.Tables["ShortEvent"]);
                    ds.Tables["ShortEvent"].AcceptChanges();
